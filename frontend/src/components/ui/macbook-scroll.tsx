  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="mb-20 text-center max-w-[600px] text-5xl font-bold text-zinc-400 dark:text-white"
      >
        {title || (
          <span>
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="absolute inset-0 h-[22rem] w-[32rem] rounded-2xl bg-[#010101] p-2"
      >
